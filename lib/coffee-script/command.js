(function() {
  ...
  outputPath = function(source, base, extension) {
    var baseDir, basename, dir, filename, srcDir;
    if (extension == null) {
      extension = ".js";
    }
    ...
    filename = opts.fluent ? basename : basename + extension;
